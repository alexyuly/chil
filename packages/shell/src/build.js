...
const buildComponent = require('@component-trees/build')

const build = ({ sourcePath }) => {
  const message = chalk.green(`tree build ${sourcePath}`)
  ...
  console.info(chalk.yellow(`tree build wrote file to ${buildPath}`))
